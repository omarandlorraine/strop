...
pub const ABSX_OPCODES: [Opcode; 15] = [
    ADC, SBC, INC, DEC, AND, ASL, CMP, EOR, LDA, LDY, LSR, ORA, ROL, ROR, STA,
];
...
pub const IMP_OPCODES: [Opcode; 25] = [
    CLC, CLD, SEC, SED, SEI, CLI, RTI, BRK, CLV, DEX, DEY, INX, INY, NOP, PHA, PLA, PLP, RTS, TAX,
    TAY, TSX, TXS, TYA, TXA, PHP,
];
...
pub const ZP_OPCODES: [Opcode; 21] = [
    ROL, INC, DEC, LSR, ROR, ASL, CPY, ADC, AND, BIT, CMP, CPX, EOR, LDA, LDX, LDY, ORA, SBC, STA,
    STX, STY,
];

pub const ZPX_OPCODES: [Opcode; 16] = [

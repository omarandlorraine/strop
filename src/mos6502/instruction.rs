...
impl Instruction for Instruction6502 {
    ...
    fn to_bytes(&self) -> Vec<u8> {
        match (self.opcode, self.operand) {
            ...
            (Opcode::ORA, Operand::Absolute(addr)) => vec![0x0d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ASL, Operand::Absolute(addr)) => vec![0x0e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::ORA, Operand::AbsoluteY(addr)) => vec![0x19, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ORA, Operand::AbsoluteX(addr)) => vec![0x1d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ASL, Operand::AbsoluteX(addr)) => vec![0x1e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],

            (Opcode::JSR, Operand::Absolute(addr)) => vec![0x20, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::BIT, Operand::Absolute(addr)) => vec![0x2c, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::AND, Operand::Absolute(addr)) => vec![0x2d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ROL, Operand::Absolute(addr)) => vec![0x2e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::AND, Operand::AbsoluteY(addr)) => vec![0x39, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::AND, Operand::AbsoluteX(addr)) => vec![0x3d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ROL, Operand::AbsoluteX(addr)) => vec![0x3e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::JMP, Operand::Absolute(addr)) => vec![0x4c, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::EOR, Operand::Absolute(addr)) => vec![0x4d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LSR, Operand::Absolute(addr)) => vec![0x4e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::EOR, Operand::AbsoluteY(addr)) => vec![0x59, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::EOR, Operand::AbsoluteX(addr)) => vec![0x5d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LSR, Operand::AbsoluteX(addr)) => vec![0x5e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::JMP, Operand::Indirect(addr)) => vec![0x6c, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ADC, Operand::Absolute(addr)) => vec![0x6d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ROR, Operand::Absolute(addr)) => vec![0x6e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::ADC, Operand::AbsoluteY(addr)) => vec![0x79, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ADC, Operand::AbsoluteX(addr)) => vec![0x7d, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::ROR, Operand::AbsoluteX(addr)) => vec![0x7e, addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::STY, Operand::Absolute(addr)) => vec![0x8c , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::STA, Operand::Absolute(addr)) => vec![0x8d , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::STX, Operand::Absolute(addr)) => vec![0x8e , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::STA, Operand::AbsoluteY(addr)) => vec![0x99 , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::TXS, Operand::Implied) => vec![0x9a],
            (Opcode::STA, Operand::AbsoluteX(addr)) => vec![0x9d , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::LDY, Operand::Absolute(addr)) => vec![0xac , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LDA, Operand::Absolute(addr)) => vec![0xad , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LDX, Operand::Absolute(addr)) => vec![0xae , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::LDA, Operand::AbsoluteY(addr)) => vec![0xb9 , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::TSX, Operand::Implied) => vec![0xba],
            (Opcode::LDY, Operand::AbsoluteX(addr)) => vec![0xbc , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LDA, Operand::AbsoluteX(addr)) => vec![0xbd , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::LDX, Operand::AbsoluteY(addr)) => vec![0xbe , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::CPY, Operand::Absolute(addr)) => vec![0xcc , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::CMP, Operand::Absolute(addr)) => vec![0xcd , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::DEC, Operand::Absolute(addr)) => vec![0xce , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::CMP, Operand::AbsoluteY(addr)) => vec![0xd9 , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::CMP, Operand::AbsoluteX(addr)) => vec![0xdd , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::DEC, Operand::AbsoluteX(addr)) => vec![0xde , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::CPX, Operand::Absolute(addr)) => vec![0xec , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::SBC, Operand::Absolute(addr)) => vec![0xed , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::INC, Operand::Absolute(addr)) => vec![0xee , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            ...
            (Opcode::SBC, Operand::AbsoluteY(addr)) => vec![0xf9 , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::SBC, Operand::AbsoluteX(addr)) => vec![0xfd , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (Opcode::INC, Operand::AbsoluteX(addr)) => vec![0xfe , addr.to_le_bytes()[0], addr.to_le_bytes()[1]],
            (_, _) => panic!(),
        }
    }

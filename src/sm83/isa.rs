...
impl crate::Step for Insn {
    ...
    fn next(&mut self) -> IterationResult {
        ...
        if self.0[0] == 0xff {
            ...
            self.incr_at_offset(self.decode().bytes - 1);
            self.fixup();
            Ok(())
        }
    }
...
impl OperandDef {
    ...
    fn write_thru(operand: Operand) -> Self {
        Self {
            operand,
            writes: false,
            reads: true,
...
const UNPREFIXED: [InstructionData; 256] = [
    InstructionData {
        mnemonic: "nop",
        opcode: 0x00,
        bytes: 1,
    ...
    InstructionData {
        ...
        bytes: 3,
        cycles: 12,
        operands: vec![OperandDef::write(Operand::BC), OperandDef::imm16()],
        z: false,
        n: false,
        h: false,
        c: false,
    ...
    InstructionData {
        ...
        cycles: 8,
        operands: vec![
            OperandDef::write_thru(Operand::BC),
            OperandDef::read(Operand::A),
        ],
        z: false,
        n: false,
        h: false,
    ...
    InstructionData {
        ...
        bytes: 1,
        cycles: 8,
        operands: vec![OperandDef::rmw(Operand::BC)],
        z: false,
        n: false,
        h: false,
        c: false,
    ...
    InstructionData {
        ...
        bytes: 1,
        cycles: 4,
        operands: vec![OperandDef::rmw(Operand::B)],
        z: true,
        n: true,
        h: true,
        c: false,

...
impl<I: Instruction + std::cmp::PartialOrd + std::cmp::PartialEq + Clone> Default
...
impl<I: Instruction + std::cmp::PartialOrd + Clone> SearchAlgorithm for BruteForceSearch<I> {
    type Item = I;
...
impl<I: Instruction + std::cmp::PartialOrd + std::cmp::PartialEq + Clone> BruteForceSearch<I> {

...
impl BruteForceSearch<Z80InstructionSet> {
    ...
    pub fn z88dkfastcall<Operand, Return>(self, func: fn(Operand) -> Option<Return>) -> testers::Z88dkfastcall<Self, Operand, Return> 
        where u32: HammingDistance<Return>, u32: AsPrimitive<Operand>, u32: From<Operand>, Standard: Distribution<Operand>, Operand: std::marker::Copy + num::traits::AsPrimitive<u32>

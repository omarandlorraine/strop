...
missing, which will result in suboptimal programs being generated for some functions.
Notably, branching and other control flow instructions are completely absent from strop.
But probably the best instruction sets so far are:
